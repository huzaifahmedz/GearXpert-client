...
const ChatBot = () => {
  ...
  return (
    <>
      {/* Chatbot Icon */}
      <div
        className="w-12 h-12 lg:w-24 lg:h-24 fixed right-1 bottom-3 z-50 cursor-pointer"
      ...
      {/* Chat Window */}
      {isChatOpen && (
        <div className="fixed bottom-20 right-5 w-72 lg:w-96 h-80 bg-black border-2 border-red-500 rounded-lg flex flex-col">
          {/* Chat Header */}
